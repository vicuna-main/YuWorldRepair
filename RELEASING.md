...
6. 使用标签 `v2.1.0-rc1` 创建 GitHub prerelease。
...
```text
YuWorldRepair-2.1.0-rc1+mc1.21.1-neoforge.jar
YuWorldRepair-2.1.0-rc1+mc1.21.1-neoforge-sources.jar
SHA256SUMS
```

离线实验工具可以作为额外附件，但必须明确标记 `experimental`。不要把 `1.0.0` 观察版和 `2.1.0-rc1` 维护版描述为可以同时安装。
