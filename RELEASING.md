...
6. 使用标签 `v2.1.0-rc2` 创建 GitHub prerelease。
...
YuWorldRepair-2.1.0-rc2+mc1.21.1-neoforge-sources.jar
SHA256SUMS
```

离线实验工具可以作为额外附件，但必须明确标记 `experimental`。不要把 `1.0.0` 观察版和 `2.1.0-rc2` 维护版描述为可以同时安装。
